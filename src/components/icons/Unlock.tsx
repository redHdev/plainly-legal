...
const SvgUnlock = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    ...
    <path d="M80 224c-8.832 0-16-7.168-16-16v-80C64 57.406 121.406 0 192 0s128 57.406 128 128c0 8.832-7.168 16-16 16s-16-7.168-16-16c0-52.93-43.07-96-96-96s-96 43.07-96 96v80c0 8.832-7.168 16-16 16zm0 0" />
  </svg>
);
